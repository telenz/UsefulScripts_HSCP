...
workdir = "/scratch/hh/dust/naf/cms/user/telenz/grid-control-For-HSCP/parameter_scan/grid-control/work.job_7"
...
f  = open('Analysis_Samples.txt', 'w')
f2 = open('Analysis_Samples_withWidth.txt', 'w')
fCuts = open('Analysis_Cuts.txt', 'w')
...
for outputdir in outputdirs[0:1000]:   
    ...
    # create entry in xsection dictionary if needed 
    #if not slhaname in xsect:
    #    xsect.update([[slhaname,[]]])
    #    print slhaname
    #    #print xsect
...
for outputdir in outputdirs[0:1000]:
    ...
    f.write('"' + str(rootfileName) + '"')
    f2.write('"' + str(rootfileName) + '"')
    fCuts.write('"' + str(rootfileName) + '"')
    ...
    f.write(rootfileName.split("width")[1])
...
# print output
#for slhaname,xsects in xsect.iteritems():
#    #print slhaname,xsect
#    print ""
